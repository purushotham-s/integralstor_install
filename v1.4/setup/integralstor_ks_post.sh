...
cd /opt/integralstor
/usr/bin/wget -c http://192.168.1.150/netboot/distros/centos/7.2/x86_64/integralstor/v1.0/non-rpms/i1.4/integralstor_utils.tar.gz
...
/usr/bin/wget -c http://192.168.1.150/netboot/distros/centos/7.2/x86_64/integralstor/v1.0/non-rpms/i1.4/integralstor.tar.gz
...
cd /tmp
/usr/bin/wget -c http://192.168.1.150/netboot/distros/centos/7.2/x86_64/integralstor/v1.0/non-rpms/i1.4/sysstat-11.0.5.tar.xz
...
cd /tmp
/usr/bin/wget -c http://192.168.1.150/netboot/distros/centos/7.2/x86_64/integralstor/v1.0/non-rpms/i1.4/setuptools-29.0.1.tar.gz
...
cd /tmp
/usr/bin/wget -c http://192.168.1.150/netboot/distros/centos/7.2/x86_64/integralstor/v1.0/non-rpms/i1.4/uwsgi-2.0.9.tar.gz
...
cd /tmp
/usr/bin/wget -c http://192.168.1.150/netboot/distros/centos/7.2/x86_64/integralstor/v1.0/non-rpms/i1.4/netifaces-0.10.5.tar.gz
...
cd /tmp
/usr/bin/wget -c http://192.168.1.150/netboot/distros/centos/7.2/x86_64/integralstor/v1.0/non-rpms/i1.4/six-1.10.0.tar.gz
...
cd /tmp
/usr/bin/wget -c http://192.168.1.150/netboot/distros/centos/7.2/x86_64/integralstor/v1.0/non-rpms/i1.4/python-dateutil-2.6.0.tar.gz
...
cd /tmp
/usr/bin/wget -c http://192.168.1.150/netboot/distros/centos/7.2/x86_64/integralstor/v1.0/non-rpms/i1.4/python-crontab-2.1.1.tar.gz
...
cd /tmp
/usr/bin/wget -c http://192.168.1.150/netboot/distros/centos/7.2/x86_64/integralstor/v1.0/non-rpms/i1.4/mbuffer-20161115.tgz
...
cd /tmp
/usr/bin/wget -c http://192.168.1.150/netboot/distros/centos/7.2/x86_64/integralstor/v1.0/non-rpms/i1.4/zfs-auto-snapshot.tar.gz
...
cd /tmp
/usr/bin/wget -c http://192.168.1.150/netboot/distros/centos/7.2/x86_64/integralstor/v1.0/non-rpms/i1.4/Django-1.8.16.tar.gz
...
cd /tmp
/usr/bin/wget -c http://192.168.1.150/netboot/distros/centos/7.2/x86_64/integralstor/v1.0/non-rpms/i1.4/cron_descriptor-1.2.6.tar.gz
...
cd /tmp
/usr/bin/wget -c http://192.168.1.150/netboot/distros/centos/7.2/x86_64/integralstor/v1.0/non-rpms/i1.4/nagios-plugins-2.1.4.tar.gz
...
cd /tmp
/usr/bin/wget -c http://192.168.1.150/netboot/distros/centos/7.2/x86_64/integralstor/v1.0/non-rpms/i1.4/3.0.1.tar.gz
...
/usr/bin/wget -c http://192.168.1.150/netboot/distros/centos/7.2/x86_64/integralstor/v1.0/non-rpms/i1.4/netatalk.tar.gz
...
touch /opt/integralstor/integralstor/version
echo "u1.4.0" > /opt/integralstor/integralstor/version
