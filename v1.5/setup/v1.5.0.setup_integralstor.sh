...
nrpm_path="http://192.168.1.150/netboot/distros/centos/7.4/x86_64/integralstor/v1.5.0/non-rpms"
...
then
  ...
  cd /etc/yum.repos.d
  /usr/bin/wget -c http://192.168.1.150/netboot/distros/centos/7.4/x86_64/integralstor/v1.5.0/integralstor.repo
